...
@WebServlet("/serverExplorer_test.do")
public class ServerExplorerServlet_test extends HttpServlet{
...
//			req.setAttribute("includePage", "/WEB-INF/views/serverExplorer.jsp");
			req.getRequestDispatcher("/WEB-INF/views/serverExplorer_test.jsp").forward(req, resp);
		}
